...
class Amounts {
  ...
  Amounts.fromJson(Map<String, dynamic> json) {
    handlingFee = json['handlingFee'] != null ? UnitPrice.fromJson(json['handlingFee']) : null;
    insurance = json['insurance'] != null ? UnitPrice.fromJson(json['insurance']) : null;
    shippingAndHandling = json['shippingAndHandling'] != null ? UnitPrice.fromJson(json['shippingAndHandling']) : null;
    shippingDiscount = json['shippingDiscount'] != null ? UnitPrice.fromJson(json['shippingDiscount']) : null;
    subtotal = json['subtotal'] != null ? UnitPrice.fromJson(json['subtotal']) : null;
