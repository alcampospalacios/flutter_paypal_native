...
class FlutterPaypalNative {
  ...
  /// * [paypalOrder] This parameter is an entity created by the response of [create order from paypal api], we recommended that this data being passed encrypted from server. If `autoCaptureFromClient` is `true` this param is required. You can use:
  /// ``` Dart
